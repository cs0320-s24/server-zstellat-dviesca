...
public class FactoryFailureException extends Exception {
  ...
  /**
   * Error provided to catch any error that may occur when you create an object from a row. * This
   * is also called when the search can not be completed due to the potential lack of column *
   * search functionality for some RowOperator implementations.
   *
  ...
  /**
   * Error provided to catch any error that may occur when you create an object from a row. This is
   * also called when the search can not be completed due to the potential lack of column search
   * functionality for some RowOperator implementations.
   *
  ...
  /**
   * Returns the response map provided (if any) as the root cause of this exception.
   *

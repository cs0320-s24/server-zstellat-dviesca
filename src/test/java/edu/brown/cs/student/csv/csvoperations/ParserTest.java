...
class ParserTest {
  ...
  //                + "server-zstellat-dviesca/data/RI/RI City & Town Income from American Community
  // Survey "
  //                + "5-Year Estimates Source_ US Census Bureau, 2017-2021 American Community
  // Survey
  // 5-Year "
  ...
  //  }
  //
  //  // Tests if it returns the correct error if the data doesn't work with the RowOperator
  // converter
  //  @Test
  ...
  //        ("Error: RowOperator failed to parse this row: " + Arrays.asList("John", "25", "New
  // York"));

package edu.brown.cs.student.server.csvServer;
...
class LoadHandlerTest {
  ...
  //        assertThrows(FileNotFoundException.class, () -> loadHandler.loadCSV("nonexistent.csv",
  // "true"));
  //    }
  //
  //    @Test
  ...
  // loadHandler.loadCSV("RI_Town_Income.csv", "invalid"));
  //    }
  //
  //    @Test
  //    void testPathTraversalAttackPrevention() {
  //        loadHandler.setFilePath("../../etc/passwd");
  //        assertThrows(SecurityException.class, () -> loadHandler.loadCSV("../../etc/passwd",
  // "true"));
  //    }
}
